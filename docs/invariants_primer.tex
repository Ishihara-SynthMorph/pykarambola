...
\begin{enumerate}
  ...
  \item \textbf{Generating set, not a minimal basis.}
        The output of \texttt{compute\_invariants()} is a generating set:
        it contains all invariants up to the chosen degree, but it may include
        algebraic dependencies (e.g.\ Cayley--Hamilton relations among triple
        traces).
