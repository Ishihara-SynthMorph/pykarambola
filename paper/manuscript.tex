...
The \texttt{compute} argument accepts \texttt{'standard'} (14 base tensors plus eigensystems), \texttt{'all'} (adds higher-order terms \texttt{w103}, \texttt{w104}, the spherical Minkowski summary quantities \texttt{msm}, anisotropy indices \texttt{\_beta}, and tensor traces \texttt{\_trace}/\texttt{\_trace\_ratio}, the latter two being pykarambola-specific extensions not present in C++ karambola), or an explicit list of names for selective computation.
