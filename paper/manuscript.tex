...
\added{We benchmark the numerical accuracy of pykarambola against the C++ karambola in two steps: (i) synthetic shapes, where analytical values provide independent ground truth, and (ii) biological datasets, which representative practical applications in 3D morphometry. 
