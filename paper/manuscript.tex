...
Rigorous shape analysis of three-dimensional objects is grounded in Minkowski functionals: four additive, motion-invariant scalar measures that, by Hadwiger's theorem, span the space of all such functionals on convex bodies in $\mathbb{R}^3$~\cite{SchroderTurk2013}.
...
Minkowski tensors are independent tensor-valued shape measures that extend this framework by accumulating directional contributions from the object's surface geometry~\cite{SchroderTurk2013}.
