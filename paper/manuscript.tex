...
\caption{%
  ...
  $K$ denotes the body with boundary $\partial K$.
  $\mathbf{x}$ is a position vector.
  $n_i$ is the $i$-th component of the unit outward surface normal.
  $H=(\kappa_1{+}\kappa_2)/2$ is the mean curvature.
  $K_G$ is the Gaussian curvature.
