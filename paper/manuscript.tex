...
Most morphometry tools in this ecosystem report simple scalar descriptors (volume, surface area, sphericity), and those that expose directional information, such as the inertia tensor available through \texttt{skimage.measure.regionprops} (\texttt{inertia\_tensor}, \texttt{inertia\_tensor\_eigvals}), largely recapitulate scalar axis-length measurements without encoding surface-weighted shape anisotropy.
