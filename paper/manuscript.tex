...
The absolute time saved by Cython grows with mesh size, meaning the benefit is most pronounced for large meshes and batch analyses where initialisation cost dominates.
