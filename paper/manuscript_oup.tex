...
%%   make oup_marked    → manuscript_oup.pdf       (tracked changes visible)
%%   make oup_clean     → manuscript_oup_clean.pdf (clean, no markup)
...
% Double spacing as required by the journal
\usepackage{setspace}
...
\doublespacing
% Captions remain single-spaced even in double-spaced manuscripts
...
\\[6pt]
\textbf{Availability and implementation:} pykarambola is distributed under the BSD 3-Clause License and is available on GitHub at \url{https://github.com/Ishihara-SynthMorph/pykarambola}. It can be installed via pip: \texttt{pip install pykarambola}.%
}

\keywords{3D morphometry, Minkowski tensors, morphometry, 3D image analysis, Python, bioimage analysis}
...
\section{Funding}
%% -------------------------------------------------------
This work was supported in part by an American Heart Association Career Development Award
(\href{https://dx.doi.org/10.13039/https://ror.org/013kjyp64}{https://dx.doi.org/10.13039/https://ror.org/013kjyp64};
grant/award number 25CDA1432232) to K.I.
...
%% -------------------------------------------------------
pykarambola was developed by directly referencing the source code of karambola, the C++ reference implementation by Schaller, Kapfer, and Schr\"{o}der-Turk~\cite{Schaller2020karambola}.
