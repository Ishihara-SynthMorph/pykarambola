%% REVISED MANUSCRIPT — marked version (tracked changes)
...
\usepackage[addedmarkup=colored,deletedmarkup=sout,authormarkup=none]{changes}
\definecolor{chgadded}{RGB}{34,139,34}   % forest green for additions
\definecolor{chgdeleted}{RGB}{180,0,0}   % red for deletions
\colorlet{Changes@Color@added}{chgadded}
\colorlet{Changes@Color@deleted}{chgdeleted}
% For sentences containing \cite{}, use \newtxt{} instead of \added{} to avoid
% natbib/changes package conflicts with citation argument parsing.
