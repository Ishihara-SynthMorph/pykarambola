...
\definecolor{chgadded}{RGB}{0,100,200}
...
\added{Users encountering open or non-manifold meshes in their own datasets can repair them using established mesh-processing tools such as MeshLab~\cite{Cignoni2008meshlab}, Open3D~\cite{Zhou2018open3d}, or PyVista~\cite{Sullivan2019pyvista} prior to passing the mesh to pykarambola.}
