...
% Standardise all addition markup to plain green text (no underline).
% \newtxt{} and \added{} are identical; \newtxt{} is used where \cite{}
% appears inside the argument to avoid natbib/changes conflicts.
